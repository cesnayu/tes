...
with st.form("form_pengaturan"):
    ...
    submit_btn = st.form_submit_button("Tampilkan Semua Data & Grafik")

# ==========================================
# PROSES EKSEKUSI DATA
# ==========================================
if submit_btn:
    # 1. Membersihkan dan menyiapkan list saham
    ...
    if not clean_tickers:
        st.error("Silakan masukkan minimal satu kode saham.")
    else:
        # ==========================================
        # BAGIAN 1: TABEL PERBANDINGAN
        # ==========================================
        st.markdown("---") # Garis pembatas
        st.subheader("📋 Tabel Perbandingan (3 & 12 Bulan)")
        
        with st.spinner("Mengambil data tabel..."):
            ...
            if data_tabel:
                ...
                st.warning("Tidak ada data tabel yang ditemukan.")

        # ==========================================
        # BAGIAN 2: GRAFIK SAHAM
        # ==========================================
        st.markdown("---") # Garis pembatas
            ...
            for ticker in clean_tickers:
                try:
                    ...
                    if not hist.empty:
                        ...
                        # Padding agar tidak menempel di garis
                        ...
                        st.warning(f"Data grafik tidak tersedia untuk {ticker} pada rentang waktu {rentang_waktu}.")
                except Exception as e:
