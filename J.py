    ...
    if not tickers:
        ...
        with st.spinner("Mengambil data dari Yahoo Finance..."):
            ...
            for ticker in tickers:
                try:
                    ...
                    if not hist.empty:
                        ...
                        # --- LOGIKA PENGECEKAN 12 BULAN ---
                        # Buang zona waktu agar bisa dibandingkan dengan start_date_12m
                        first_date = hist.index[0].tz_localize(None) 
                        
                        # Jika jarak tanggal pertama ke target 12 bln lalu > 14 hari, berarti saham baru IPO
                        ...
                        # --- LOGIKA PENGECEKAN 3 BULAN ---
                        # Pastikan zona waktu disamakan saat mencari data 3 bln lalu
                        tz = hist.index.tz
            ...
            if data:
                ...
                # Fungsi styling warna (hanya untuk yang berupa angka/bukan "-")
